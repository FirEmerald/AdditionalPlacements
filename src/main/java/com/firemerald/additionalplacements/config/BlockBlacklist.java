...
public class BlockBlacklist extends GenerationBlacklist {
	...
	public void addToConfig(ModConfigSpec.Builder builder) {
		...
		modWhitelistConfig = builder
				...
				.defineListAllowEmpty(Collections.singletonList("mod_whitelist"), () -> defaultModWhitelist, o -> o instanceof String);
		modBlacklistConfig = builder
				.comment("Blacklist for mods whose blocks will be disabled. Takes priority over the mod whitelist.")
				.defineListAllowEmpty(Collections.singletonList("mod_blacklist"), () -> defaultModBlacklist, o -> o instanceof String);
		tagWhitelistConfig = builder
				...
				.defineListAllowEmpty(Collections.singletonList("tag_whitelist"), () -> defaultTagBlacklist, o -> o instanceof String);
		tagBlacklistConfig = builder
				...
				.defineListAllowEmpty(Collections.singletonList("tag_blacklist"), () -> defaultTagWhitelist, o -> o instanceof String);
		blockWhitelistConfig = builder
				...
				.defineListAllowEmpty(Collections.singletonList("block_whitelist"), () -> defaultBlockWhitelist, o -> o instanceof String);
		blockBlacklistConfig = builder
				...
				.defineListAllowEmpty(Collections.singletonList("block_blacklist"), () -> defaultBlockBlacklist, o -> o instanceof String);
	}
