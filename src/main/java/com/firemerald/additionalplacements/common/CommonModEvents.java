...
public class CommonModEvents implements ModInitializer
{
    ...
    public void onInitialize()
    {
    	...
    	ServerLifecycleEvents.SERVER_STARTED.register(client -> CommonModEvents.init());
	...
	{
		if (misMatchedTags && !(AdditionalPlacementsMod.COMMON_CONFIG.autoRebuildTags.get() && AdditionalPlacementsMod.SERVER_CONFIG.autoRebuildTags.get()) && TagMismatchChecker.canGenerateTags(handler.getPlayer())) handler.getPlayer().sendMessage(TagMismatchChecker.MESSAGE, Util.NIL_UUID);
	}
