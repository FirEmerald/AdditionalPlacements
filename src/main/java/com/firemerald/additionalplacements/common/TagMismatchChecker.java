...
public class TagMismatchChecker extends Thread implements Consumer<ServerTickEvent>
{
	...
	public static final Component MESSAGE = 
			...
			.append(Component.literal("/ad_tags_export").setStyle(Style.EMPTY.withClickEvent(new ClickEvent(Action.RUN_COMMAND, "/ad_tags_export")).withColor(ChatFormatting.BLUE).withUnderlined(true)))
