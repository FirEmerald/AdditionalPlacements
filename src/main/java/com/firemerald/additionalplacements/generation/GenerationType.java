...
public abstract class GenerationType<T extends Block, U extends AdditionalPlacementBlock<T>> {
	 ...
	 * @return
	 */
	public void checkClientData(CompoundNBT tag, Consumer<MessageTree> logError) {}
	 ...
	 * @return
	 */
	public CompoundNBT getServerCheckData() {
		return null;
	}
	 ...
	 * @return
	 */
	public void checkServerData(CompoundNBT tag, Consumer<MessageTree> logError) {}
