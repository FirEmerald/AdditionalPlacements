...
public class ClientEventHandler
{
	...
	public static void onScreenOpening(ScreenOpenEvent event) {
		if (Minecraft.getInstance().screen instanceof ConnectionErrorsScreen && event.getScreen() instanceof DisconnectedScreen) event.setCanceled(true);
	}
}