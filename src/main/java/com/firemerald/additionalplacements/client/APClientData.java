...
public class APClientData
{
	...
	public static void setPlacementEnabledAndSynchronize(boolean state, boolean showMessage)
	{
		...
		if (player != null)
		{
			...
			if (showMessage) player.displayClientMessage(new TranslatableComponent(placementEnabled ? "msg.additionalplacements.placement_enable" : "msg.additionalplacements.placement_disable"), true);
		}
	}
