...
public class APClientData
{
	...
	public static void setPlacementEnabledAndSynchronize(boolean state)
	{
		...
		if (player != null)
		{
			...
			player.displayClientMessage(new TranslatableComponent(placementEnabled ? "msg.additionalplacements.placement_enable" : "msg.additionalplacements.placement_disable"), true);
		}
	}
