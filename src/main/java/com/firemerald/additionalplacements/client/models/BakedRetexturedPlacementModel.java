...
public class BakedRetexturedPlacementModel extends PlacementModelWrapper
{
	...
	{
		BlockState modelState = BlockModelUtils.getModeledState(state);
		return BlockModelUtils.retexturedQuads(side, dir -> ourModel.getQuads(state, dir, rand, extraData, renderType), dir -> originalModel.getQuads(modelState, dir, rand, extraData, renderType), renderType);
	}
}
