...
public class BakedRotatedPlacementModel extends PlacementModelWrapper
{
	...
	public List<BakedQuad> getQuads(BlockState state, Direction side, RandomSource rand)
	{
		...
		return BlockModelUtils.rotatedQuads(modelRotation, rotatesTexture, side, dir -> parent.getQuads(modelState, dir, rand), null);
	}
	...
	{
		BlockState modelState = BlockModelUtils.getModeledState(state);
		return BlockModelUtils.rotatedQuads(modelRotation, rotatesTexture, side, dir -> parent.getQuads(modelState, dir, rand, extraData, renderType), renderType);
	}
}
