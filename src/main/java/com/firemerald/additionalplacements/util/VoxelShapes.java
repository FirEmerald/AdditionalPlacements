...
public class VoxelShapes
{
	...
	//facing
	STAIRS_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_DOWN, PILLAR_UP_NORTH), //NNN+PNN+NNP+PNP+NPN+PPN
	STAIRS_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_DOWN, PILLAR_UP_SOUTH), //NNN+PNN+NNP+PNP+NPP+PPP
	STAIRS_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_UP, PILLAR_DOWN_NORTH), //NPN+PPN+NPP+PPP+NNN+PNN
	STAIRS_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_UP, PILLAR_DOWN_SOUTH), //NPN+PPN+NPP+PPP+NNP+PNP
	STAIRS_UP_EAST = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_DOWN, PILLAR_WEST_UP), //NNN+PNN+NNP+PNP+NPN+NPP
	STAIRS_UP_WEST = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_DOWN, PILLAR_EAST_UP), //NNN+PNN+NNP+PNP+PPN+PPP
	STAIRS_DOWN_EAST = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_UP, PILLAR_WEST_DOWN), //NPN+PPN+NPP+PPP+NNN+NNP
	STAIRS_DOWN_WEST = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_UP, PILLAR_EAST_DOWN), //NPN+PPN+NPP+PPP+PNN+PNP
	STAIRS_EAST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_WEST, PILLAR_EAST_NORTH), //NNN+NPN+NNP+NPP+PNN+PPN
	STAIRS_EAST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_WEST, PILLAR_EAST_SOUTH), //NNN+NPN+NNP+NPP+PNP+PPP
	STAIRS_WEST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_EAST, PILLAR_WEST_NORTH), //PNN+PPN+PNP+PPP+NNN+NPN
	STAIRS_WEST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_EAST, PILLAR_WEST_SOUTH), //PNN+PPN+PNP+PPP+NNP+NPP
	//12
	STAIRS_INNER_EAST_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.join(BLOCK, CORNER_EAST_UP_SOUTH, IBooleanFunction.ONLY_FIRST), //NNN+PNN+NPN+PPN+NNP+PNP+NPP
	STAIRS_INNER_WEST_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.join(BLOCK, CORNER_WEST_UP_SOUTH, IBooleanFunction.ONLY_FIRST), //NNN+PNN+NPN+PPN+NNP+PNP+PPP
	STAIRS_INNER_EAST_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.join(BLOCK, CORNER_EAST_DOWN_SOUTH, IBooleanFunction.ONLY_FIRST), //NNN+PNN+NPN+PPN+NNP+NPP+PPP
	STAIRS_INNER_WEST_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.join(BLOCK, CORNER_WEST_DOWN_SOUTH, IBooleanFunction.ONLY_FIRST), //NNN+PNN+NPN+PPN+PNP+NPP+PPP
	STAIRS_INNER_EAST_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.join(BLOCK, CORNER_EAST_UP_NORTH, IBooleanFunction.ONLY_FIRST), //NNN+PNN+NPN+NNP+PNP+NPP+PPP
	STAIRS_INNER_WEST_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.join(BLOCK, CORNER_WEST_UP_NORTH, IBooleanFunction.ONLY_FIRST), //NNN+PNN+PPN+NNP+PNP+NPP+PPP
	STAIRS_INNER_EAST_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.join(BLOCK, CORNER_EAST_DOWN_NORTH, IBooleanFunction.ONLY_FIRST), //NNN+NPN+PPN+NNP+PNP+NPP+PPP
	STAIRS_INNER_WEST_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.join(BLOCK, CORNER_WEST_DOWN_NORTH, IBooleanFunction.ONLY_FIRST), //PNN+NPN+PPN+NNP+PNP+NPP+PPP
	//20
	STAIRS_OUTER_EAST_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_DOWN_NORTH, CORNER_WEST_UP_NORTH, CORNER_WEST_DOWN_SOUTH), //NNN+PNN+NPN+NNP
	STAIRS_OUTER_WEST_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_DOWN_NORTH, CORNER_EAST_UP_NORTH, CORNER_EAST_DOWN_SOUTH), //NNN+PNN+PPN+PNP
	STAIRS_OUTER_EAST_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_UP_NORTH, CORNER_WEST_DOWN_NORTH, CORNER_WEST_UP_SOUTH), //NNN+NPN+PPN+NPP
	STAIRS_OUTER_WEST_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_UP_NORTH, CORNER_EAST_DOWN_NORTH, CORNER_EAST_UP_SOUTH), //PNN+NPN+PPN+PPP
	STAIRS_OUTER_EAST_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_DOWN_SOUTH, CORNER_WEST_UP_SOUTH, CORNER_WEST_DOWN_NORTH), //NNN+NNP+PNP+NPP
	STAIRS_OUTER_WEST_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_DOWN_SOUTH, CORNER_EAST_UP_SOUTH, CORNER_EAST_DOWN_NORTH), //PNN+NNP+PNP+PPP
	STAIRS_OUTER_EAST_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_UP_SOUTH, CORNER_WEST_DOWN_SOUTH, CORNER_WEST_UP_NORTH), //NPN+NNP+NPP+PPP
	STAIRS_OUTER_WEST_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_UP_SOUTH, CORNER_EAST_DOWN_SOUTH, CORNER_EAST_UP_NORTH), //PPN+PNP+NPP+PPP
	//28
	STAIRS_FLAT_EAST_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_WEST, CORNER_EAST_DOWN_NORTH),
	STAIRS_FLAT_EAST_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_WEST, CORNER_EAST_UP_NORTH),
	STAIRS_FLAT_EAST_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_WEST, CORNER_EAST_DOWN_SOUTH),
	STAIRS_FLAT_EAST_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_WEST, CORNER_EAST_UP_SOUTH),
	STAIRS_FLAT_WEST_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_EAST, CORNER_WEST_DOWN_NORTH),
	STAIRS_FLAT_WEST_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_EAST, CORNER_WEST_UP_NORTH),
	STAIRS_FLAT_WEST_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_EAST, CORNER_WEST_DOWN_SOUTH),
	STAIRS_FLAT_WEST_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_EAST, CORNER_WEST_UP_SOUTH),
	//36
	STAIRS_FLAT_UP_EAST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_DOWN, CORNER_WEST_UP_NORTH),
	STAIRS_FLAT_UP_WEST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_DOWN, CORNER_EAST_UP_NORTH),
	STAIRS_FLAT_UP_EAST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_DOWN, CORNER_WEST_UP_SOUTH),
	STAIRS_FLAT_UP_WEST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_DOWN, CORNER_EAST_UP_SOUTH),
	STAIRS_FLAT_DOWN_EAST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_UP, CORNER_WEST_DOWN_NORTH),
	STAIRS_FLAT_DOWN_WEST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_UP, CORNER_EAST_DOWN_NORTH),
	STAIRS_FLAT_DOWN_EAST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_UP, CORNER_WEST_DOWN_SOUTH),
	STAIRS_FLAT_DOWN_WEST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_UP, CORNER_EAST_DOWN_SOUTH),
	//44
	STAIRS_FLAT_SOUTH_EAST_UP = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_NORTH, CORNER_WEST_DOWN_SOUTH),
	STAIRS_FLAT_SOUTH_WEST_UP = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_NORTH, CORNER_EAST_DOWN_SOUTH),
	STAIRS_FLAT_SOUTH_EAST_DOWN = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_NORTH, CORNER_WEST_UP_SOUTH),
	STAIRS_FLAT_SOUTH_WEST_DOWN = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_NORTH, CORNER_EAST_UP_SOUTH),
	STAIRS_FLAT_NORTH_EAST_UP = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_SOUTH, CORNER_WEST_DOWN_NORTH),
	STAIRS_FLAT_NORTH_WEST_UP = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_SOUTH, CORNER_EAST_DOWN_NORTH),
	STAIRS_FLAT_NORTH_EAST_DOWN = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_SOUTH, CORNER_WEST_UP_NORTH),
	STAIRS_FLAT_NORTH_WEST_DOWN = net.minecraft.util.math.shapes.VoxelShapes.or(SLAB_SOUTH, CORNER_EAST_UP_NORTH),
	//52
	STAIRS_TWIST_CLOCKWISE_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_WEST_DOWN, PILLAR_EAST_NORTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_UP_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_EAST_DOWN, PILLAR_WEST_NORTH),
	STAIRS_TWIST_CLOCKWISE_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_EAST_DOWN, PILLAR_WEST_SOUTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_UP_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_WEST_DOWN, PILLAR_EAST_SOUTH),
	STAIRS_TWIST_CLOCKWISE_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_WEST_UP, PILLAR_EAST_NORTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_DOWN_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_EAST_UP, PILLAR_WEST_NORTH),
	STAIRS_TWIST_CLOCKWISE_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_EAST_UP, PILLAR_WEST_SOUTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_DOWN_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_WEST_UP, PILLAR_EAST_SOUTH),
	//60
	STAIRS_TWIST_CLOCKWISE_UP_EAST = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_DOWN_SOUTH, PILLAR_WEST_NORTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_UP_EAST = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_DOWN_NORTH, PILLAR_WEST_SOUTH),
	STAIRS_TWIST_CLOCKWISE_UP_WEST = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_DOWN_NORTH, PILLAR_EAST_SOUTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_UP_WEST = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_DOWN_SOUTH, PILLAR_EAST_NORTH),
	STAIRS_TWIST_CLOCKWISE_DOWN_EAST = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_UP_SOUTH, PILLAR_WEST_NORTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_DOWN_EAST = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_UP_NORTH, PILLAR_WEST_SOUTH),
	STAIRS_TWIST_CLOCKWISE_DOWN_WEST = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_UP_NORTH, PILLAR_EAST_SOUTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_DOWN_WEST = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_UP_SOUTH, PILLAR_EAST_NORTH),
	//68
	STAIRS_TWIST_CLOCKWISE_EAST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_WEST_DOWN, PILLAR_UP_NORTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_EAST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_WEST_UP, PILLAR_DOWN_NORTH),
	STAIRS_TWIST_CLOCKWISE_EAST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_WEST_UP, PILLAR_DOWN_SOUTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_EAST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_WEST_DOWN, PILLAR_UP_SOUTH),
	STAIRS_TWIST_CLOCKWISE_WEST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_EAST_UP, PILLAR_DOWN_NORTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_WEST_SOUTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_EAST_DOWN, PILLAR_UP_NORTH),
	STAIRS_TWIST_CLOCKWISE_WEST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_EAST_DOWN, PILLAR_UP_SOUTH),
	STAIRS_TWIST_COUNTER_CLOCKWISE_WEST_NORTH = net.minecraft.util.math.shapes.VoxelShapes.or(PILLAR_EAST_UP, PILLAR_DOWN_SOUTH);
	//76
