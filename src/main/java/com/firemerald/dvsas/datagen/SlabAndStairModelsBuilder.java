...
public class SlabAndStairModelsBuilder
{
	...
	{
		return setBase(DVSaSMod.MOD_ID, SLAB_BASE, DVSaSMod.MOD_ID, STAIRS_BASE).addAction((builder, model) ->
		builder
		.texture("side", side)
		.texture("top", top)
		.texture("bottom", bottom));
	...
	{
		return setBase(DVSaSMod.MOD_ID, SLAB_COLUMN, DVSaSMod.MOD_ID, STAIRS_COLUMN).addAction((builder, model) ->
		builder
		.texture("side", side)
		.texture("end", end));
	}
	...
	{
		return setBase(DVSaSMod.MOD_ID, SLAB_SIDE_ALL, DVSaSMod.MOD_ID, STAIRS_SIDE_ALL).addAction((builder, model) ->
		builder
		.texture("all", all));
	}
