...
import com.firemerald.dvsas.block.StairStateHelper.EnumPlacing;
import com.firemerald.dvsas.block.StairStateHelper.EnumShape;
import com.firemerald.dvsas.block.StairStateHelper.PartialState;
...
public interface IStairBlock extends IVerticalBlock
{
	...
	{
		return this instanceof StairBlock && DVSaSMod.COMMON_CONFIG.disableAutomaticStairPlacement.get();
	}
